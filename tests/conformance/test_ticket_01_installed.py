...
def test_installed_wheel_shields_nested_deepseek_cancellation_cleanup(
    installed_python: Path,
) -> None:
...
def test_installed_wheel_completes_programmatic_product_journey(
    installed_python: Path,
) -> None:
    _assert_installed_scenario(installed_python, "ticket_22_scenario.py")


def test_installed_wheel_completes_one_shot_command_mode(
    installed_python: Path,
) -> None:
