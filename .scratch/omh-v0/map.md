...
- [Define the v0 conformance and release gate](issues/12-define-v0-conformance-and-release-gate.md) — Require a closed authority matrix, reproducible fixed-Reference corpus and universal wheel, two macOS installed-artifact rows, a human-owned live DeepSeek gate, and hash-bound human release authorization.
